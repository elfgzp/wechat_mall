...
class Order(models.Model):
    ...
    amount = fields.Float('商品总金额', requried=True, default=0)
    amount_logistics = fields.Float('物流费用', requried=True, default=0)
    amount_real = fields.Float('实际支付', requried=True, default=0, track_visibility='onchange')
    ...
    def create(self, vals):
        vals['order_num'] = self.env['ir.sequence'].get('wechat_mall.order_num')
